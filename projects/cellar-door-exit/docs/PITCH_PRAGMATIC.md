...
- **~300 bytes.** Smaller than a tweet.
...
- **Minimal:** 300 bytes. Seven fields. Integrate in an afternoon.
...
- **Not a philosophy project.** EXIT is a 300-byte JSON document with a cryptographic signature. It's plumbing.
