...
8. A reference implementation comprising five npm packages with 395 passing tests, including framework integrations for LangChain, Vercel AI SDK, and MCP
...
The reference implementation—five npm packages, 395 passing tests, framework integrations for LangChain, Vercel AI SDK, and MCP—demonstrates that the protocol is implementable with sub-millisecond ceremony timing and compact markers. The alignment with W3C DIDs, Verifiable Credentials, FIPA agent lifecycle models, ISO/IEC 42001 AI management systems, NIST AI 100-1 risk management, and the emerging NIST AI Agent Standards Initiative positions the Passage Protocol within an established standards ecosystem rather than as an isolated effort.
