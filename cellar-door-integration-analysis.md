...
**What we'd build:** Python package `cellar-door-exit-crewai` with a thin Python EXIT marker creator (port the ~300 bytes of marker creation), or a REST endpoint that the Python code calls.
